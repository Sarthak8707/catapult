...
const Login = () => {
    return (
        <div className='min-h-screen bg-gray-300 flex items-center justify-center'>
            <div className='h-120 w-90 bg-white rounded-lg flex flex-col items-center'>
                ...
                <div className='mt-12'>
                    <div>
                        <button className='bg-indigo-900 w-68 h-8 text-white rounded-sm cursor-pointer
                        hover:bg-indigo-800 transition-colors duration-200 '> Login </button>
                    </div>
