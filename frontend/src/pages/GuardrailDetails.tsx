...
const GuardrailDetails = () => {
    ...
    const [reducing, setReducing] = useState(true);
  return (
        ...
        <div className='mt-10 h-100 bg-white py-5 px-5 flex border-red-400'>
            ...
            <div className='pl-3  w-110 border-blue-500'>
                ...
                <div className='border text-sm border-gray-200 rounded-sm flex flex-col h-70 py-3 px-3 mt-5'>
                    ...
                    <Separator />
                    <div className='mt-2'>
                        <div className='flex items-center h-10 gap-3 '> <Switch checked={reducing} onCheckedChange={() => setReducing((prev) => !prev)}/> <div> Reduce Rollout Percentage </div> </div>
                        <div className='mt-1'>
                            <Slider
                             defaultValue={[75]}
                             max={100}
                             step={1}
                             className="mx-auto w-full max-w-xs" disabled={!reducing}
                            />
                        </div>
                    </div>
                </div>
